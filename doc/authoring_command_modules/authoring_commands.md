...
[9. Supporting Name or ID Parameters](#supporting-name-or-id-parameters)

[10. Generic Update Commands](#generic-update-commands)

[11. Custom Table Formats](#custom-table-formats)

[12. Tab Completion (bash only)](#tab-completion)

[13. Validators](#validators)

[14. Registering Flag Arguments](#registering-flags)

[15. Registering Enum Arguments](#registering-enums)

[16. Preventing particular extensions from being loading](#extension-suppression)
